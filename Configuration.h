...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "MY k800"
...
// Center-to-center distance of the holes in the diagonal push rods.// Tan gan chang du!!
#define DELTA_DIAGONAL_ROD 207.8//MY_DELTA_DIAGONAL_ROD//220.32//215.78 // 215.5//217mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 148.8//MY_DELTA_SMOOTH_ROD_OFFSET//151.6 // mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 34//MY_DELTA_EFFECTOR_OFFSET // mm

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 21//MY_DELTA_CARRIAGE_OFFSET // mm 9 22.7//6.5 20.2

// Horizontal distance bridged by diagonal push rods when effector is centered.
#define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)

// Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
#define DELTA_PRINTABLE_RADIUS 40//MY_DELTA_PRINTABLE_RADIUS
