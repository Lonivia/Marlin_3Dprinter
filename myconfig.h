...
#define MY_DELTA_DIAGONAL_ROD 207.6//210.14//220.32//215.78 // 215.5//217mm

// Horizontal offset from middle of printer to smooth rod center.
// 打印头到滑杆水平距离
#define MY_DELTA_SMOOTH_ROD_OFFSET 250.32//152.5//151.6 // mm

// Horizontal offset of the universal joints on the end effector.
// 效应器球中心和打印头的水平距离
#define MY_DELTA_EFFECTOR_OFFSET 35.23//32 // mm

// Horizontal offset of the universal joints on the carriages.
// 滑车球中心到滑杆水平距离
#define MY_DELTA_CARRIAGE_OFFSET 19.94//19.6 // mm 9 22.7//6.5 20.2

// Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
// 打印半径？
#define MY_DELTA_PRINTABLE_RADIUS 40.0
...
#define MY_MANUAL_Z_HOME_POS 273.8//263.2//293.0//211.5//221.3//211  60 227.2  jhead 234.3// For delta: Distance between nozzle and print surface after homing.

// 回Home的速度控制，速度单位:毫米/秒
// 这个参数建议改改，原来的数值是200，你装好一按HOME，滑车就会高速撞到顶部（或底部，步进装反了），改小点滑车的速度就慢点安全点
#define MY_HOMING_FEEDRATE_SPEED 50 // set the homing speeds (mm/second)
